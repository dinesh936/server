...
// // connect mongodp
// mongoose.connect('mongodb+srv://dinesh:dinesh@cluster0.5smao.mongodb.net/bank').then(()=>{console.log("DB")})
// //create schema 
// let data=new mongoose.Schema({name:String,
//     email:String,
//     passsword:String,
//     amount:Number,
// })
...
// Connect MongoDB
mongoose.connect('mongodb+srv://dinesh:dinesh@cluster0.5smao.mongodb.net/bank')
    .then(() => {
